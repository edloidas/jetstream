...
const extensions = CONFIG.tasks.html.extensions.map(
  ext => path.join( CONFIG.root.src, CONFIG.tasks.html.src, `/**/*.${ ext }` )
);
...
function getData() {
  const dataPath = path.resolve(
    CONFIG.root.src, CONFIG.tasks.html.src, CONFIG.tasks.html.dataFile
  );
